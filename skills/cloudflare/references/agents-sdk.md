...
### Core
- **[agents-sdk/state-scheduling.md](agents-sdk/state-scheduling.md)** — State persistence, scheduling, SQL
- **[agents-sdk/callable.md](agents-sdk/callable.md)** — RPC methods, streaming, timeouts
- **[agents-sdk/routing.md](agents-sdk/routing.md)** — URL patterns, custom routing, `getAgentByName`
- **[agents-sdk/configuration.md](agents-sdk/configuration.md)** — Wrangler config, bindings, Vite setup

### Chat & Streaming
- **[agents-sdk/streaming-chat.md](agents-sdk/streaming-chat.md)** — AIChatAgent, resumable streams, tools
- **[agents-sdk/client-sdk.md](agents-sdk/client-sdk.md)** — `useAgent`, `useAgentChat`, `AgentClient`
- **[agents-sdk/server-driven-messages.md](agents-sdk/server-driven-messages.md)** — Trigger patterns, `saveMessages`
- **[agents-sdk/human-in-the-loop.md](agents-sdk/human-in-the-loop.md)** — Approval flows, `needsApproval`

### Background Processing
- **[agents-sdk/workflows.md](agents-sdk/workflows.md)** — Durable Workflows integration
- **[agents-sdk/durable-execution.md](agents-sdk/durable-execution.md)** — `runFiber`, `stash`, surviving eviction
- **[agents-sdk/queue-retries.md](agents-sdk/queue-retries.md)** — Built-in queue, retry with backoff

### Integrations
- **[agents-sdk/mcp.md](agents-sdk/mcp.md)** — MCP client and server, transports, securing
- **[agents-sdk/email.md](agents-sdk/email.md)** — Email routing and handling
- **[agents-sdk/webhooks-push.md](agents-sdk/webhooks-push.md)** — Webhooks, push notifications
- **[agents-sdk/observability.md](agents-sdk/observability.md)** — Diagnostics-channel events

### Experimental
- **[agents-sdk/think.md](agents-sdk/think.md)** — `@cloudflare/think` higher-level chat agent
- **[agents-sdk/voice.md](agents-sdk/voice.md)** — `@cloudflare/voice` STT/TTS
- **[agents-sdk/codemode.md](agents-sdk/codemode.md)** — Code Mode for tool orchestration
- **[agents-sdk/browse-the-web.md](agents-sdk/browse-the-web.md)** — CDP browser tools
