...
For other frameworks see [clerk-react-patterns](../clerk-react-patterns.md), `clerk-astro-patterns`, `clerk-react-router-patterns`, [clerk-tanstack-patterns](../clerk-tanstack-patterns.md).
