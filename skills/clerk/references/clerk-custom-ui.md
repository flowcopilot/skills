...
> **Prerequisite**: Ensure `ClerkProvider` wraps your app. See [clerk-setup](clerk-setup.md) skill.
>
> **Version**: Check `package.json` for the SDK version — see [Clerk router](../SKILL.md) for the version table. This determines which custom flow references to use below.
...
| Task | Reference |
|------|-----------|
| Custom sign-in (Core 2 / LTS) | clerk-custom-ui/core-2/custom-sign-in.md |
| Custom sign-up (Core 2 / LTS) | clerk-custom-ui/core-2/custom-sign-up.md |
| Custom sign-in (Current SDK v7+) | clerk-custom-ui/core-3/custom-sign-in.md |
| Custom sign-up (Current SDK v7+) | clerk-custom-ui/core-3/custom-sign-up.md |
| Show component pattern (Current SDK) | clerk-custom-ui/core-3/show-component.md |

## Custom Flow References

| Task | Core 2 | Current |
|------|--------|---------|
| Custom sign-in (useSignIn) | `clerk-custom-ui/core-2/custom-sign-in.md` | `clerk-custom-ui/core-3/custom-sign-in.md` |
| Custom sign-up (useSignUp) | `clerk-custom-ui/core-2/custom-sign-up.md` | `clerk-custom-ui/core-3/custom-sign-up.md` |
| `<Show>` component | *(use `<SignedIn>`, `<SignedOut>`, `<Protect>`)* | `clerk-custom-ui/core-3/show-component.md` |
...
2. For custom flows: check SDK version → read appropriate `clerk-custom-ui/core-2/` or `clerk-custom-ui/core-3/` reference
