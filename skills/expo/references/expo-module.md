...
See [expo-module/create-expo-module.md](expo-module/create-expo-module.md) before scaffolding or extending a module. It covers:
...
Note: iOS uses just the class name; Android uses the fully-qualified class name (package + class). See `expo-module/module-config.md` for all fields.
