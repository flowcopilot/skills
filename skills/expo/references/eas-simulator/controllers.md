...
All four types include a web preview. Before setting `--max-idle-time-minutes`, follow [Session lifetime](../eas-simulator.md#session-lifetime); activity does not reset the timer for every interface.
