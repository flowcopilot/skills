...
Disclosed reference for [`expo-web-to-native`](../expo-web-to-native.md), step 4. `false-friends.md` translates *idioms* (`div` → `View`); this translates *UX patterns* - a web interaction into its native equivalent. Step 4 isn't a port, it's this redesign.
