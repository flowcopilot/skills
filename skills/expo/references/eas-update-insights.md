...
For the complete schema and field reference, see [eas-update-insights/update-insights-schema.md](eas-update-insights/update-insights-schema.md).
...
For the complete schema and field reference, see [eas-update-insights/channel-insights-schema.md](eas-update-insights/channel-insights-schema.md).
