...
See [expo-app-clip/native-module.md](expo-app-clip/native-module.md) for the Swift module, TypeScript interface, and usage.

## References

- expo-app-clip/native-module.md — Local Expo module to detect App Clip context and present the SKOverlay install prompt
