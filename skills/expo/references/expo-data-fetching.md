...
Network-status detection with NetInfo and offline-first React Query setup: see [expo-data-fetching/offline-and-cancellation.md](expo-data-fetching/offline-and-cancellation.md).
...
AbortController on unmount (React Query cancels automatically): see [expo-data-fetching/offline-and-cancellation.md](expo-data-fetching/offline-and-cancellation.md).
...
User asks about networking
  ...
  |   \-- Expo Router loaders — see expo-data-fetching/expo-router-loaders.md
  |
  |-- Basic fetch?
...
-> See expo-data-fetching/expo-router-loaders.md for route-level loaders (web, SDK 55+). For native, use React Query or fetch.
