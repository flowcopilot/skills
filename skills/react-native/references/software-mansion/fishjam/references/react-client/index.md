...
> **Read `../platform/index.md` first.** It defines what rooms, peers, tokens, and the sandbox-vs-prod model are. This skill assumes those.
>
> **For React Native, use `../react-native-client/index.md` instead** — it re-exports this hook surface and adds mobile-only concerns.
