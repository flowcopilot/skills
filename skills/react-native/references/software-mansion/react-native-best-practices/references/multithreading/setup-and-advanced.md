...
Enablement (babel plugin options, Expo/RN CLI metro config helpers, the mandatory metro + metro-runtime patches, verification) is covered end-to-end by the dedicated sub-skill: `../enable-worklets-bundle-mode/index.md`. Follow it instead of setting up manually.
