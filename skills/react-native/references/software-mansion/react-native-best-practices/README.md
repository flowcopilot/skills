...
├── index.md                              # Entry point: routing table for sub-skills
└── references/
    ├── animations/
    │   ├── index.md                      # When to use, what references to read
    ...
    ├── gestures/
    │   ├── index.md                      # Version decision tree (v2 Builder vs v3 Hook API)
    ...
    ├── svg/
    │   ├── index.md                      # When to use react-native-svg vs alternatives
    ...
    ├── on-device-ai/
    │   ├── index.md                      # Decision tree, critical rules, references routing
    ...
    ├── rich-text/
    │   └── index.md                      # Editor and renderer patterns, style customization
    ├── multithreading/
    │   ├── index.md                      # Runtime model, API decision tree, critical rules
    ...
    │   ├── index.md                      # State detection, babel plugin, metro config, patches, verification
    │   └── references/
    ...
    └── jsi/
        ├── index.md                      # Decision tree, references routing
...
4. **Register it** in the parent `index.md` sub-skills table
5. **Keep index.md under 500 lines**. Move detailed content to reference files and link to them with a "when to read" table.
