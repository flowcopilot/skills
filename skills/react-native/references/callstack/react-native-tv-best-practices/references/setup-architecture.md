...
Use this shape as a detection aid, not a required layout. The important review question is whether TV-native folders and packaging files match the stack detected in [index.md](../index.md).
