<!-- Modified by Flow Copilot from callstackincubator/agent-skills revision 61e6e7dfdf3a8ee862254c200d751fcb1fb863dc. -->

# Migrating to React Native

Use this skill only after the decision to adopt brownfield migration has been made. When the user is still choosing between brownfield, greenfield, a checkpoint-based path, defer, or no migration, use [assess-react-native-migration](../assess-react-native-migration/index.md) first.
...
| Problem | Start With |
|---------|------------|
| Need migration path decision first | [assess-react-native-migration](../assess-react-native-migration/index.md) |
...
- [Assess React Native migration](../assess-react-native-migration/index.md) before selecting the migration path.
