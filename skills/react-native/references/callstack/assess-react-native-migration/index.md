...
After Path A is accepted, hand implementation planning to [react-native-brownfield-migration](../react-native-brownfield-migration/index.md). Do not repeat its Expo, XCFramework, AAR, or host-integration guidance.
